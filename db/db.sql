...
INSERT INTO `Collection` VALUES ('0xda5C8ee681981487d2cCB097A058d706fe34566E','07269350-c492-11eb-bcf3-6d26016d413e','Animals','This collection has animal portraits','');
...
CREATE TABLE `Item` (
  ...
  `CollectionId` varchar(100) NOT NULL,
  `SensitiveContent` bit(1) NOT NULL DEFAULT b'0',
...
--
/*!50003 DROP PROCEDURE IF EXISTS `GetItemsOfCollection` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `GetItemsOfCollection`(UserId VARCHAR(100), CollectionId INT)
BEGIN
	SELECT i.ItemId, i.Name, i.CollectionId, i.Description, i.ExternalLink, i.File FROM Item i 
inner join Collection c on c.CollectionId =i.CollectionId 
where c.UserId = UserId AND c.CollectionId = CollectionId;
...
BEGIN
	SELECT i.ItemId,i.Name, s.Price,c.`Type`,i.Image, i.Description,i.ExternalLink,i.SensitiveContent 
	FROM Item i
...
-- Dump completed on 2021-06-03 22:59:24
